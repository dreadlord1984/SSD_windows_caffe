...
#include "caffe/FRCNN/smooth_L1_loss_layer2.hpp"
...
template <typename Dtype>
void SmoothL1LossDLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(SmoothL1LossDLayer);
