...
bool UpgradeV1LayerParameter(const V1LayerParameter& v1_layer_param,
  ...
  for (int i = 0; i < v1_layer_param.blob_share_mode_size(); ++i) {
    ...
    case _V1LayerParameter_DimCheckMode_STRICT:
      mode = _ParamSpec_DimCheckMode_STRICT;
      break;
    case _V1LayerParameter_DimCheckMode_PERMISSIVE:
      mode = _ParamSpec_DimCheckMode_PERMISSIVE;
      break;
    default:
