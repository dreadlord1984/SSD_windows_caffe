...
if __name__ == '__main__':
    ...
    path_to_logs = ["../Data_480_320/min_size_1.25_first/min_size_1.25_first.log"]  # log文件
    for path_to_log in path_to_logs:
        if not os.path.exists(path_to_log):
            print 'Path does not exist: %s' % path_to_log
            sys.exit()
    ...
    path_to_logs = ["../Data_480_320/min_size_1.25_second/min_size_1.25_second.log"]  # log文件
    for path_to_log in path_to_logs:
        if not os.path.exists(path_to_log):
            print 'Path does not exist: %s' % path_to_log
            sys.exit()
