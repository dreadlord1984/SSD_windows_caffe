...
if __name__ == "__main__":
    save_data("../Data_0825/IOU_ALL_image_List.txt",
              "../View/COMPARE/NONE_A75G20_S_D_P/result_ALL_image_List.txt",
              "../View/COMPARE/NONE_A75G20_S_D_P/IOU_change_curve.mat")
    show_hist("../View/COMPARE/NONE_A75G20_S_D_P/IOU_change_curve.mat")